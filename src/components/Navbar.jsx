  ...
  return (
    ...
    >
      ...
      <div className="w-10 mr-3 md:mr-0 ml-auto h-10 rounded-full flex items-center justify-center bg-[#1826360c] dark:bg-[#182636] text-[#182636] relative cursor-pointer dark:text-[#c7d6f0d2] ">
        <img className="w-10 mr-3 md:mr-0 ml-auto h-10 rounded-full flex items-center justify-center bg-[#1826360c] dark:bg-[#182636] text-[#182636] relative cursor-pointer dark:text-[#c7d6f0d2] " src={ProfilePic}   alt=""  />
      </div>
